...
interface SelectProps extends React.ComponentPropsWithoutRef<typeof SelectPrimitiveRoot> {
  label?: string;
  options?: { label: string; value: string }[];
  placeholder?: string;
  className?: string;
  onChange?: (e: any) => void; // Mimic legacy onChange
  noDefault?: boolean; // Legacy prop, ignored but kept for compatibility
...
const Select = ({ label, options, placeholder, className, onChange, value, defaultValue, onValueChange, ...props }: SelectProps) => {
  ...
  const handleValueChange = (val: string) => {
    ...
    // Legacy support: mimic an event object for old handlers
    if (onChange) {
